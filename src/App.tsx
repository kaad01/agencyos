  ...
  return (
    <main className="shell">
      ...
      <section className="workspace">
        ...
        {view === 'Time' && <TimeView data={data} activeTimer={activeTimer} now={now} onStartTimer={startTimer} onStopTimer={stopTimer} onCancelTimer={cancelTimer} onNew={() => { setTimeEntryDraft(null); setModal('time'); }} onQuickLog={quickLogTicket} onEdit={editTimeEntry} onDelete={deleteTimeEntry} />}
