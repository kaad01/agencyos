...
function TimeView({ data, onNew }: { data: AppData; onNew: () => void }) {
  ...
  const weeklyRows = weeklyTimesheetByColleague(data, latestDate).filter((row) => row.total > 0);
